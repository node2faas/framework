...
function checkDepedencies(){
  let checkTerraform = global.shelljs.exec('which terraform').stdout;
  if (!checkTerraform){
...
function getProvider() {
  if (global.provider == 'clean' && global.fs.existsSync(global.homedir+'/.node2faas_provider')){
    ...
    global.shelljs.exec('cd ~/node_modules/node2faas/terraform ; terraform init',{silent:!global.debug});
