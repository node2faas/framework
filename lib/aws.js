	...
	return new Promise((resolve, reject) => {
		...
		lambda.getFunction(params, function(err, data) {
		   if (!err){
		   		...
		   		if (!err){
		   			createFunction(functionName, codePath).then(function(url){
		   				resolve(url);
		   			});
		   		} else {
					console.log('Function deletation failed:\n', err);
				}
			});
		   } else {
		   		createFunction(functionName, codePath).then(function(url){
...
function createFunction(functionName, codePath){ 
	return new Promise((resolve, reject) => {
		globalParams = require('./params')
																		  ...
																		  if (!err) { 
																				...
																				apigateway.createStage(params, function(err, data) {
																				  if (!err) {
																					...
																					resolve({'url':url,'functionName':functionName});
																				  } else {
